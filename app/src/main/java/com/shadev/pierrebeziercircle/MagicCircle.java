...
public class MagicCircle extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //由于中点向前位移一个拉伸的长度，实际位移总量应该减去该长度，再做8:10的比例换算
        float offset = (maxLength * (mInterpolatedTime - 0.2f) - stretchDistance) * 5 / 4;
    ...
    //<--所有的model状态都是基于自身作为原点，和位移距离无关，位移距离会在之后另行添加-->
